...
func (dtd *DeviceTokenDelete) sqlExec(ctx context.Context) (int, error) {
	_spec := sqlgraph.NewDeleteSpec(devicetoken.Table, sqlgraph.NewFieldSpec(devicetoken.FieldID, field.TypeString))
	_spec.Node.Schema = dtd.schemaConfig.DeviceToken
	ctx = internal.NewSchemaConfigContext(ctx, dtd.schemaConfig)

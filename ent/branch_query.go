...
func (bq *BranchQuery) QueryTenant() *TenantQuery {
...
func (bq *BranchQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (bq *BranchQuery) FirstIDX(ctx context.Context) string {
...
func (bq *BranchQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (bq *BranchQuery) OnlyIDX(ctx context.Context) string {
...
func (bq *BranchQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (bq *BranchQuery) IDsX(ctx context.Context) []string {
	ids, err := bq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (bq *BranchQuery) WithTenant(opts ...func(*TenantQuery)) *BranchQuery {
	query := (&TenantClient{config: bq.config}).Query()
...
func (bq *BranchQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Branch, error) {
	...
	_spec.Node.Schema = bq.schemaConfig.Branch
...
func (bq *BranchQuery) loadTenant(ctx context.Context, query *TenantQuery, nodes []*Branch, init func(*Branch), assign func(*Branch, *Tenant)) error {
	ids := make([]string, 0, len(nodes))
	nodeids := make(map[string][]*Branch)
	for i := range nodes {
		fk := nodes[i].TenantID
...
func (bq *BranchQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := bq.ctx.Fields; len(fields) > 0 {
		...
		if bq.withTenant != nil {
			_spec.Node.AddColumnOnce(branch.FieldTenantID)
		}
	}
...
func (bq *BranchQuery) sqlQuery(ctx context.Context) *sql.Selector {
	...
	t1.Schema(bq.schemaConfig.Branch)
	ctx = internal.NewSchemaConfigContext(ctx, bq.schemaConfig)

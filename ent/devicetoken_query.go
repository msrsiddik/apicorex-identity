...
func (dtq *DeviceTokenQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (dtq *DeviceTokenQuery) FirstIDX(ctx context.Context) string {
...
func (dtq *DeviceTokenQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (dtq *DeviceTokenQuery) OnlyIDX(ctx context.Context) string {
...
func (dtq *DeviceTokenQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (dtq *DeviceTokenQuery) IDsX(ctx context.Context) []string {
	ids, err := dtq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//		GroupBy(devicetoken.FieldTokenHash).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.DeviceToken.Query().
//		Select(devicetoken.FieldTokenHash).
//		Scan(ctx, &v)
...
func (dtq *DeviceTokenQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*DeviceToken, error) {
	...
	_spec.Node.Schema = dtq.schemaConfig.DeviceToken
	ctx = internal.NewSchemaConfigContext(ctx, dtq.schemaConfig)
	for i := range hooks {
		hooks[i](ctx, _spec)
	}
...
func (dtq *DeviceTokenQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(devicetoken.Table, devicetoken.Columns, sqlgraph.NewFieldSpec(devicetoken.FieldID, field.TypeString))
	_spec.From = dtq.sql
...
func (dtq *DeviceTokenQuery) sqlQuery(ctx context.Context) *sql.Selector {
	...
	t1.Schema(dtq.schemaConfig.DeviceToken)
	ctx = internal.NewSchemaConfigContext(ctx, dtq.schemaConfig)
